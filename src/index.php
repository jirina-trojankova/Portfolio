...
<body>
    ...
    <section id="home">
        <main id="content" class="container">
            ...
            <h4>I am full stack web develeper based in Prague, working with HTML5, CSS, JavaScript and PHP. For my work I use
                jQuery, React, MySql, Laravel, GitHub, Photoshop, Node.js, gulp, Sass, Bootstrap. </h4>
            <br/>
            <br/>
                    ...
                    <div class="card mb-4">
                        <div class="light_gray_card  light_gray_clr">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Platform where travellers and locals meet. We made this as our Bootcamp project with two
                                    other people. Still in progress.</p>
                                <h6>Tech stack:</h6>
        ...
        <div class="about_me container">
            ...
            <div class="row">
                ...
                <div class="my_text col-sm-6 col-md-7 col-lg-9">
                    <p>My name is Jiřina Trojánková. I am a full-stack web developer. I am developing user interfaces in JavaScript
                        and React and backend of my projects in PHP and Laravel. I enjoy learning new trends.</p>
                    <p>I am open to learning new technologies and enjoy working with people who are as passionate about all
                        web-related as me.</p>
                    <p>I like travelling and I am based in Prague, Czech Republic.</p>
                    <p>I like horseriding, cycling and snowboarding. If I do not develop, you can also meet me trekking in the
                        mountains.
                    </p>
